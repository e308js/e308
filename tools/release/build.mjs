...
const manifest = {
  ...
  packages,
  gates: [
    gate("D1", "PASS", "docs/evidence/tmt/index.json", "independent source audit pending"),
    gate("D1R", "PASS", "docs/evidence/reference-games.json", "independent source review pending"),
    gate("D2", "PASS", "artifacts/finished-games/reports.json", "independent walkthrough pending"),
    ...
    gate("D5", "PASS", "playwright-report/", "independent desktop and touch review pending"),
