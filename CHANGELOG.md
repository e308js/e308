...
- Added the deterministic headless simulation core, typed numeric adapters, scoped mechanics,
  persistence, crash-safe offline progress, browser/worker hosts, bot harness, pacing tools, and
  checked time advancement.
- Added the optional framework-independent UX package with semantic DOM controls, localization,
  formatting, effects, starter styling, and replaceable game-owned composition.
